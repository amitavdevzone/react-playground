...
class Accordion extends Component {
  ...
  componentDidMount() {
    const tabNumber = 2;
    const newAccordion = this.state.accordions.find((accordion) => {
      return accordion.id === tabNumber;
    });
    this.handleClick(newAccordion);
    this.setPanelHeight(`.panel-${tabNumber}`, false);
  }
